...
class Scene7LightCastersSpotlight private constructor(
    ...
    override fun draw() {
        ...
        cubeProgram.setFloat3("light.direction", camera.getFront())
        cubeProgram.setFloat3("light.position", camera.getEye())
    ...
    override fun init(width: Int, height: Int) {
        ...
        cubeProgram.setFloat("light.cutOff", cos(radians(12.5f)))
        cubeProgram.setFloat("light.outerCutOff", cos(radians(17.5f)))
    ...
    companion object {
        ...
        fun create(context: Context): Scene {
            ...
            return Scene7LightCastersSpotlight(
                vertexShaderCode = resources.readRawTextFile(R.raw.lighting_scene4_lighting_maps_cube_vert),
                fragmentShaderCode = resources.readRawTextFile(R.raw.lighting_scene7_light_casters_spotlight_frag),
