...
class Scene8CubemapsSkybox private constructor(
    ...
    override fun init(width: Int, height: Int) {
        ...
        cubeVertexData.addAttribute(cubeProgram.getAttributeLocation("aTexCoords"), 2, 3)
        cubeVertexData.bind()
    ...
    companion object {
        ...
        fun create(context: Context): Scene {
            ...
            return Scene8CubemapsSkybox(
                cubeVertexShaderCode = resources.readRawTextFile(R.raw.simple_texture_mvp_vert),
                cubeFragmentShaderCode = resources.readRawTextFile(R.raw.simple_texture_frag),
