...
class Scene7Transformations private constructor(
    ...
    override fun draw() {
        ...
        val transform = translation(Float3(0.5f, -0.5f, 0.0f)) *
                scale(Float3(0.5f, 0.5f, 0.0f)) *
                rotation(Float3(0.0f, 0.0f, 1.0f), timer.sinceStartSecs() * 5.0f)
        glUniformMatrix4fv(
    ...
    companion object {
        ...
        fun create(context: Context): Scene {
            ...
            return Scene7Transformations(
                vertexShaderCode = resources.readRawTextFile(R.raw.gettingstarted_scene7_transformations_vert),
