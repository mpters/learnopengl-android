...
class Scene4NormalMapping private constructor(
    ...
    private fun initQuadVertexData() {
        ...
        val quadVertices = floatArrayOf(
            pos1.x, pos1.y, pos1.z, nm.x, nm.y, nm.z, uv1.x, uv1.y, tang1.x, tang1.y, tang1.z,
            pos2.x, pos2.y, pos2.z, nm.x, nm.y, nm.z, uv2.x, uv2.y, tang1.x, tang1.y, tang1.z,
            pos3.x, pos3.y, pos3.z, nm.x, nm.y, nm.z, uv3.x, uv3.y, tang1.x, tang1.y, tang1.z,

            pos1.x, pos1.y, pos1.z, nm.x, nm.y, nm.z, uv1.x, uv1.y, tang2.x, tang2.y, tang2.z,
            pos3.x, pos3.y, pos3.z, nm.x, nm.y, nm.z, uv3.x, uv3.y, tang2.x, tang2.y, tang2.z,
            pos4.x, pos4.y, pos4.z, nm.x, nm.y, nm.z, uv4.x, uv4.y, tang2.x, tang2.y, tang2.z
        )

        vertexData = VertexData(quadVertices, null, 11)
    ...
    companion object {
        ...
        fun create(context: Context): Scene {
            ...
            return Scene4NormalMapping(
                vertexShaderCode = resources.readRawTextFile(R.raw.advancedlighting_scene4_normal_mapping_vert),
                fragmentShaderCode = resources.readRawTextFile(R.raw.advancedlighting_scene4_normal_mapping_frag),
                texture = Texture(loadBitmap(context, R.raw.texture_brickwall)),
                normalTexture = Texture(loadBitmap(context, R.raw.texture_brickwall_normal))
            )
        }
    }
}
