...
class Scene53ParallaxOcclusionMapping private constructor(
    ...
    companion object {
        ...
        fun create(context: Context): Scene {
            ...
            return Scene53ParallaxOcclusionMapping(
                vertexShaderCode = resources.readRawTextFile(R.raw.advancedlighting_scene51_parallax_mapping_vert),
                fragmentShaderCode = resources.readRawTextFile(R.raw.advancedlighting_scene53_parallax_occlusion_mapping_frag),
