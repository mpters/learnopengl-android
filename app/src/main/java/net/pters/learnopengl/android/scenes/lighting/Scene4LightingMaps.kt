...
class Scene4LightingMaps private constructor(
    ...
    override fun init(width: Int, height: Int) {
        ...
        cubeVertexData = VertexData(vertices, null, 8)
        ...
        lightSourceVertexData = VertexData(vertices, null, 8)
    ...
    companion object {
        ...
        fun create(context: Context): Scene {
            ...
            return Scene4LightingMaps(
                ...
                cubeFragmentShaderCode = resources.readRawTextFile(R.raw.lighting_scene4_lighting_maps_cube_frag),
