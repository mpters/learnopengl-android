...
class Scene51ParallaxMapping private constructor(
    ...
    companion object {
        ...
        fun create(context: Context): Scene {
            ...
            return Scene51ParallaxMapping(
                vertexShaderCode = resources.readRawTextFile(R.raw.advancedlighting_scene51_parallax_mapping_vert),
                fragmentShaderCode = resources.readRawTextFile(R.raw.advancedlighting_scene51_parallax_mapping_frag),
                texture = Texture(loadBitmap(context, R.raw.texture_bricks2)),
                heightTexture = Texture(loadBitmap(context, R.raw.texture_bricks2_disp)),
                normalTexture = Texture(loadBitmap(context, R.raw.texture_bricks2_normal))
            )
        }
    }
}
