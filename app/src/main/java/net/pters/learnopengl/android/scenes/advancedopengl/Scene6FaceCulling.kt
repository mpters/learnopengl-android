...
import net.pters.learnopengl.android.scenes.Vertices.cubeWithTextureCCW
import net.pters.learnopengl.android.tools.*

class Scene6FaceCulling private constructor(
    ...
    override fun init(width: Int, height: Int) {
        ...
        cubeVertexData = VertexData(cubeWithTextureCCW, null, 5)
